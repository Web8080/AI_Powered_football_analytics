...
# or use the startup script ../start_frontend.sh
...
* : View bounding boxes, player tracks, and statistics
...
- ** Interactive Charts*
* : Possession over time, team performance
...
- ** Auto-recording** : Automatically save 90
...
- ** Multiple Deployment*
* : Jetson, Raspberry Pi, cloud support
...
# React components MainDashboard.tsx

# Main dashboard VideoUpload.tsx

# Video upload interface RealTimeDashboard.tsx

# Live analytics StatisticsDashboard.tsx
...
# Static assets App.tsx

# Main app component main.tsx

# Entry point index.css

# Global styles public/

# Static files package.json

# Dependencies vite.config.ts

# Vite configuration tailwind.config.js

# Tailwind configuration tsconfig.json
...
```env VITE_API_BASE_URL=http://localhost:8000 VITE_INFERENCE_BASE_URL=http://localhost:8001 VITE_APP_NAME=Godseye AI VITE_APP_VERSION=1.0.0 ```
...
# Build Docker image docker build -t godseye-frontend .

# Run container docker run -p 3000:3000 godseye-frontend
...
# Or use different port npm run dev
...
- ** AI Insights*
* : Automated match insights and recommendations
