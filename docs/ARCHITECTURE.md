...
+ custom training on football players
...
- ** Goal Detection*
* : Goal post and net detection for field calibration
...
* : Long-term player re-identification across frames

#### Analysis Models

- **Pose Estimation** : MediaPipe

+ custom football-specific keypoints

- ** Action Recognition** : SlowFast

+ custom football actions
...
Metadata      Preprocessing  Events         Color      Fine-tune  Testing
Jitter
